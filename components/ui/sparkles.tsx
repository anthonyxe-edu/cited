        ...
        <Particles
          ...
          options={{
            ...
            interactivity: {
              ...
              modes: { push: { quantity: 2 }, repulse: { distance: 200, duration: 0.4 } },
            },
            particles: {
              color: {
                value: particleColor || "#00D4AA",
                animation: {
              ...
              shape: { type: "cited-cross", close: true, fill: true, options: {} },
              move: {
                enable: true,
                speed: { min: 0.1, max: speed || 0.5 },
                direction: "none",
                random: true,
                straight: false,
                outModes: { default: "out" },
                attract: { enable: false, distance: 200, rotate: { x: 3000, y: 3000 } },
                angle: { offset: 0, value: 90 },
                center: { x: 50, y: 50, mode: "percent", radius: 0 },
                decay: 0, distance: {}, drift: 0,
